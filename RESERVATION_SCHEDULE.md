...
All dates are planning targets and must be confirmed with official sources.
...
- Confirm booking details before departure
- Track early check-in and lounge rules

## USJ

- Studio Pass: pending official 2027 release
- Express Pass: pending official 2027 release
- VIP Experience: pending official 2027 release
- Private VIP Tour: pending official 2027 release
- Super Nintendo World timed entry: pending official 2027 rules
...
- Selected plan: phone roaming for two people
- User-provided amount: TWD 499 total
- eSIM / SIM / Pocket Wi-Fi: backup only
- Confirm carrier activation and billing before departure

## Insurance

- User-provided amount: TWD 6,900
- Payment status: needs confirmation
- Confirm policy documents, coverage period, and emergency contact information before departure

## Shopping

- Boutique appointment: confirm if needed
- Department store tax refund: confirm 2027 rules

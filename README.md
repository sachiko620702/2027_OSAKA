...
- Version：V5.61.0 Web Threads Film Rhythm Refresh
- 主控資料源：GitHub main branch
- 更新目的：在不變動資料庫與主預算基準的前提下，將公開網站改成多頁式旅行冊，讓封面、行程、預算、行前與餐飲各自成章。
...
- 公開網站：`web/` 已於 V5.61.0 強化成更接近 Threads 影片節奏的多頁式旅行冊，並把行程、預算、行前與餐飲分頁化。

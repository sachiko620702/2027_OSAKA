...
- 2027/10/10：買 KKday 機場接送與 USJ Studio Pass；KKday #129909 與 USJ 票價仍需再次確認。
...
- V5.26.0 主預算：建議版 NT$325,664／兩人，安全上限 NT$380,000／兩人；Ambassador 續約 USD 250、精品包、珠寶、手錶另計。
- V5.26.0 交通參考：使用者提供機票暫估 NT$36,000；KKday #129909 機場接送單程 NT$2,600、來回 NT$5,200；KKday #536220 飯店 ↔ USJ 接送單程 NT$1,732 起、來回 NT$3,464。上述皆為暫估，2027 價格與可訂狀態仍需再次確認。
...
- USJ 接送：InterContinental Osaka 與 USJ 來回皆使用 KKday 商品 #536220；V5.24.0 暫估單程 NT$1,732 起、來回 NT$3,464；V5.26.0 時間軸尚未指定購買日。
...
- [預約與購買時間軸 V5.26.0](docs/03_預約購買/2027大阪自由行_預約購買時間軸_V5.26.0.md)

...
- Day 3 候補：2027/11/19 新增「木津市場早午餐＋京都寶可夢／漫畫／打卡 10 小時包車」候補，不硬套 KKday 範例路線，以輕鬆吻合興趣為主。
- 餐飲方向：好吃優先，是否米其林不重要。
...
- [Day 3 木津市場京都寶可夢動漫候補包車](docs/01_行程規劃/2027-11-19_Day3_木津市場京都寶可夢動漫候補包車_V5.13.0.md)
